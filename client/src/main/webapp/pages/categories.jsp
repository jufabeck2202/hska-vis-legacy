			...
			<div>
				<ul class="nav navbar-nav">
					<li><a href="<s:url action=" listAllProducts" />">Alle Produkte</a>
						<s:if test="#session.webshop_user.rolelevel==0">
							<!-- if admin -->
					<li><a href="./InitCategorySiteAction.action?pageToGoTo=p">
							<s:text name="product.add" /></a></li>
					<li><a href="./InitCategorySiteAction.action?pageToGoTo=c">
							<s:text name="categories.edit" /></a></li>
					</s:if>
				</ul>
				<div>
	...
	<div class="container">
		...
		<div id="categories">
			<table class="table table-striped">
				<tr class="header">
					<td>
						<s:text name="categories.nr" />
					</td>
					<td>
						<s:text name="categories.name" />
					</td>
					<td></td>
				</tr>
				<s:iterator value="categories" status="rowstatus">
					<tr>
						...
						<td class="odd"><a href="<s:url action=" DeleteCategoryAction">
								<s:param name="catId" value="id" />
								</s:url>"><img src="img/delBtn.png" alt="<s:text name=" product.delete" />"/></a></td>
